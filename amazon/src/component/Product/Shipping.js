...
export default function Shipping() {
  ...
  const clickHandler = () => {
    ...
    dispatch(
      saveShippingAddress({ ...info, country: countryRef.current.value })
    );
  };
  return (
    <>
        ...
        >
          ...
          {/* <Form.Item label="Country">
            ...
            >
              ...
              <Select.Option value="Antigua & Barbuda">
                Antigua & Barbuda
              </Select.Option>
              ...
              <Select.Option value="Canary Islands">
                Canary Islands
              </Select.Option>
              ...
              <Select.Option value="Channel Islands">
                Channel Islands
              </Select.Option>
              ...
              <Select.Option value="Falkland Islands">
                Falkland Islands
              </Select.Option>
              ...
              <Select.Option value="Midway Islands">
                Midway Islands
              </Select.Option>
              ...
              <Select.Option value="Pitcairn Island">
                Pitcairn Island
              </Select.Option>
              ...
              <Select.Option value="St Kitts-Nevis">
                St Kitts-Nevis
              </Select.Option>
              ...
              <Select.Option value="Samoa American">
                Samoa American
              </Select.Option>
              <Select.Option value="San Marino">San Marino</Select.Option>
              <Select.Option value="Sao Tome & Principe">
                Sao Tome & Principe
              </Select.Option>
              ...
              <Select.Option value="Trinidad & Tobago">
                Trinidad & Tobago
              </Select.Option>
              ...
              <Select.Option value="Turks & Caicos Is">
                Turks & Caicos Is
              </Select.Option>
              ...
              <Select.Option value="Wallis & Futana Is">
                Wallis & Futana Is
              </Select.Option>
